...
description: "Complete field-by-field reference for ResolverResult, AggregatedResult, and ExtractedGitLink — the three core output types returned by GitResolve."
---

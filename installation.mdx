...
The main types you'll use are exported directly from `@clyrisai/gitresolve`:
...
You should see the version number (`0.2.1`) and the full usage output listing all available flags and options.

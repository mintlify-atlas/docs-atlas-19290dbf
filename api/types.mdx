...
sidebarTitle: "Types"
description: "Complete TypeScript type definitions for GitResolve: InputType, GitProvider, ExtractedGitLink, ResolverResult, AggregatedResult, BrowserProvider, and more."
---
...
`InputType` classifies what kind of source was passed to the resolver. It is set on `ResolverResult.sourceType` and `AggregatedResult.sourceTypes` so downstream code can decide how to handle each result.

...
description: "Auto-detect or explicitly select a BrowserProvider for portfolio scraping. Reference for FetchProvider, PuppeteerProvider, BrowserlessProvider, and the BrowserProvider interface."
---
